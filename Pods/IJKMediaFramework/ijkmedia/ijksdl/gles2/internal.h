...
typedef struct IJK_GLES2_Renderer {
    ...
    GLuint av4_position;
    //GLuint av2_texcoord;
    GLuint av2_y_texcoord;
    GLuint av2_uv_texcoord;
    GLuint um4_mvp;
    ...
    GLfloat texcoords[8];    //y
    GLfloat uv_texcoords[8]; //uv
    GLfloat vertices[8];
    ...
    int     frame_sar_num;
    int     frame_sar_den;
    float   uvRightPadding;
    float   padding_normalized;
    int     rotate_degress;
    int     degress_changed;
    GLboolean mirror;
    GLboolean mirror_changed;
} IJK_GLES2_Renderer;
...
//逆时针旋转角度
typedef enum IJK_GLES_RotateDegress {
    IJK_GLES_ROTATEDEGRESS_0,
    IJK_GLES_ROTATEDEGRESS_90,
    IJK_GLES_ROTATEDEGRESS_180,
    IJK_GLES_ROTATEDEGRESS_270,
    IJK_GLES_MIRROR_ROTATEDEGRESS_0,
    IJK_GLES_MIRROR_ROTATEDEGRESS_90,
    IJK_GLES_MIRROR_ROTATEDEGRESS_180,
    IJK_GLES_MIRROR_ROTATEDEGRESS_270,
} IJK_GLES_RotateDegress;
...
const char* IJK_GLES2_getFragmentShader_yuv420sp_vu();
