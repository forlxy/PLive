...
struct IjkMediaPlayer {
    ...
    char* data_source;
    void* weak_thiz;
    CCacheSessionListener* cache_session_listener;
    ...
    KwaiPlayerResultQos* player_result_qos;
    PlayerConfigDebugInfo player_config_debug_info;
    VodQosDebugInfo vod_qos_debug_info;
    LiveQosDebugInfo live_qos_debug_info;
};
