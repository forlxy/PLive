...
static SDL_VoutOverlay* vout_create_overlay_l(int width, int height, int frame_format,
                                              SDL_Vout* vout) {
    switch (frame_format) {
...
static SDL_VoutOverlay* vout_create_overlay(int width, int height, int frame_format,
                                            SDL_Vout* vout) {
...
static int vout_display_overlay_l(SDL_Vout* vout, SDL_VoutOverlay* overlay) {
    ...
    return [gl_view display:overlay];
}
...
static void SDL_VoutIos_SetGLView_l(SDL_Vout* vout, IJKSDLGLView* view) {
    ...
    if (view) opaque->gl_view = [view retain];
}
