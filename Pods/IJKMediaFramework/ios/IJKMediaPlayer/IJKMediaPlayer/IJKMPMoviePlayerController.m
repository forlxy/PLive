...
- (void)IJK_dispatchMPMediaPlaybackIsPreparedToPlayDidChangeNotification:
...
- (void)IJK_dispatchMoviePlayerIsAirPlayVideoActiveDidChangeNotification:
    (NSNotification*)notification {
    [[NSNotificationCenter defaultCenter]
        postNotificationName:IJKMPMoviePlayerIsAirPlayVideoActiveDidChangeNotification
                      object:notification.object
