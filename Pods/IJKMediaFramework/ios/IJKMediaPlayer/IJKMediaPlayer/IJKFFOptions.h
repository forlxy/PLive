...
@property(nonatomic) BOOL enableMixAudio;
/**
 * 复用GLView，默认为NO，如果设置为YES，则必须由外部设置GLView
 * 参考：[IJKFFMoviePlayerController newGLView]
 */
@property(nonatomic) BOOL useReuseGLView;
